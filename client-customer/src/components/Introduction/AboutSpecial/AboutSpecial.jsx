...
export default function AboutSpecial() {
  return (
    <div className="grid grid-cols-3 gap-8 items-center py-20 container-80">
      <div className="flex space-x-3">
        <div>
          <div style={{ width: 60 }}>
            <div className="icon">
              <div className="icon-inner opacity-90">
                <svg
                  version="1.1"
                  id="Capa_1"
                  ...
                  style={{ enableBackground: "new 0 0 512.008 512.008" }}
                  xmlSpace="preserve"
                >
                  <g>
                    <g>
            ...
            <div className="icon">
              <div className="opacity-90">
                <svg
                  ...
                  style={{ enableBackground: "new 0 0 612.003 612.003" }}
                  xmlSpace="preserve"
                >
                  <g>
                    <path
            ...
            <div className="icon">
              <div className="icon-inner opacity-90">
                <svg
                  ...
                  style={{ enableBackground: "new 0 0 511.933 511.933" }}
                  xmlSpace="preserve"
                >
      ...
      <div className="flex space-x-3">
        <div>
          <div className="icon-box-img" style={{ width: 60 }}>
            <div className="icon">
              <div
                className="icon-inner opacity-90"
              ...
              >
                <svg
                  ...
                  y="0px"
                  viewBox="0 0 94 94"
                  style={{ enableBackground: "new 0 0 94 94" }}
                  xmlSpace="preserve"
                >
                  <g>
                    <path
            ...
            <div className="icon">
              <div className="icon-inner opacity-90">
                <svg
                  ...
                  style={{ enableBackground: "new 0 0 419.519 419.519" }}
                  xmlSpace="preserve"
                >
                  <g>
                    <path
            ...
            <div className="icon">
              <div className="icon-inner opacity-90">
                <svg
                  ...
                  style={{ enableBackground: "new 0 0 354.796 354.796" }}
                  xmlSpace="preserve"
                >
                  <g>
                    <g id="Layer_5_58_">
